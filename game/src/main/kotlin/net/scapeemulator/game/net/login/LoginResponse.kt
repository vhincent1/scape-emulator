...
class LoginResponse {
    ...
    companion object {
        ...
        const val STATUS_FULLSCREEN_MEMBERS: Int = 19 // closed beta
        const val STATUS_LOGIN_SERVER_INVALID: Int = 20
        const val STATUS_RETRY: Int = 21 // moving worlds
        ...
        const val STATUS_UNVALIDATED_ACCOUNT = 28
        const val STATUS_WEBSITE_ERROR = 29
