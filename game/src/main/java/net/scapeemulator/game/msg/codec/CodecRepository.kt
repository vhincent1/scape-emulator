...
class CodecRepository(table: LandscapeKeyTable) {
    ...
    //    private val inCodecs: Array<MessageDecoder<*>> = arrayOfNulls(256)
...
//        bind(InterfaceOptionMessageDecoder())
    ...
    fun get(opcode: Int): MessageDecoder<*>? {
        return inCodecs[opcode] //TODO: fix
    }

    fun <T : Message> get(clazz: Class<T>): MessageEncoder<*>? {
        return outCodecs[clazz]
    }
    ...
    fun bind(encoder: MessageEncoder<*>) {
        outCodecs[encoder.clazz] = encoder
    }
}
